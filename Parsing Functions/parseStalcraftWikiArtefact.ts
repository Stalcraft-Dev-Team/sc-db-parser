...
import {
    ...
    GetAndCopyIcons, MinimizeItemInfo, MinimizeStalcraftWikiArtefactInfo,
...
export const ParseStalcraftWikiArtefact = async function ParseArtefact(pathToItemsFolder = ''): Promise<object[]> {
    ...
    fs.writeFileSync(resultFolder + '\\' + server + '_artefacts.json', JSON.stringify(
      MinimizeStalcraftWikiArtefactInfo(
